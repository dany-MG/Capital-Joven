      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-darkpanel p-6 rounded-2xl shadow-lg border border-white/5 text-center relative overflow-hidden group">
            ...
            <h3 className="text-xl font-[Satoshi-Bold] text-white relative z-10">{formData.n} {formData.n}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input type="text" name="n" value={formData.n} onChange={handleChange} className="w-full pl-10 pr-4 py-3 bg-white/5 border border-transparent rounded-xl focus:ring-1 focus:ring-emerald-500/50 focus:border-emerald-500/30 outline-none text-white transition-all duration-300" />
                </div>
              </div>
