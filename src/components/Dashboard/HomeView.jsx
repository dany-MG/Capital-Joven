...
export const HomeView = () => {
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      {/* 1. Fila de Tarjetas de Resumen (Stats) */}
      ...
      {/* 2. Grid Principal de Contenido */}
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        
        {/* Columna Izquierda (Gráfica y Transacciones) */}
        ...
        {/* Columna Derecha (Widgets pequeños) */}
        <div className="xl:col-span-1 space-y-6">
          ...
          <div className="bg-darkpanel p-6 rounded-2xl shadow-lg border border-white/5 group hover:border-emerald-500/30 transition-colors">
            ...
            <div className="space-y-4 mb-6">
              ...
              {/* Barra de progreso de predicción */}
